...
def configuration_model(
    deg_sequence, create_using: Incomplete | None = ..., seed: Incomplete | None = ...
): ...
...
def directed_havel_hakimi_graph(
    in_deg_sequence, out_deg_sequence, create_using: Incomplete | None = ...
): ...
def degree_sequence_tree(deg_sequence, create_using: Incomplete | None = ...): ...
def random_degree_sequence_graph(
    sequence, seed: Incomplete | None = ..., tries: int = ...
): ...
