...
from typing import Iterator, Tuple, Generic, Dict, Any, Tuple, Type
from networkx.classes.graph import Graph, _Edge, _Node, _NBunch
...
class NodeView(Generic[_Node]):
    ...
    def __call__(self, data: bool | str = ..., default: Any = ...) -> NodeDataView[_Node]: ...
...
class OutEdgeView(Generic[_Node]):
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[Tuple[_Node, _Node] | Tuple[_Node, _Node, Dict[str, Any]]]: ...
    def __contains__(self, e: _Edge[_Node]) -> bool: ...
    def __getitem__(self, e: _Edge[_Node]) -> Dict[str, Any]: ...
    def __call__(self, nbunch: _NBunch[_Node] = ..., data: bool | str = ..., default: Any = ...) -> OutEdgeDataView[_Node]: ...
    def data(self, data: bool | str = ..., default: Any = ..., nbunch: _NBunch[_Node] = ...) -> OutEdgeDataView[_Node]: ...
