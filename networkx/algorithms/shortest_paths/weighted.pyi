...
def single_source_dijkstra_path(
    G, source, cutoff: Incomplete | None = ..., weight: str = ...
): ...
...
def multi_source_dijkstra_path(
    G, sources, cutoff: Incomplete | None = ..., weight: str = ...
): ...
...
def all_pairs_dijkstra(
    G, cutoff: Incomplete | None = ..., weight: str = ...
...
def bellman_ford_predecessor_and_distance(
    G, source, target: Incomplete | None = ..., weight: str = ..., heuristic: bool = ...
): ...
...
def single_source_bellman_ford(
    G, source, target: Incomplete | None = ..., weight: str = ...
): ...
